import { hueToRgb, rgbToHue } from '../../../shared/palette-color.ts';
import type { ControlState } from './types.ts';

export { hexToRgb, hueToRgb, rgbToHex, rgbToHue } from '../../../shared/palette-color.ts';

export function syncPaletteFromHue(
  target: Pick<ControlState, 'palette' | 'paletteR' | 'paletteG' | 'paletteB'>,
) {
...
export function syncPaletteFromRgb(
  target: Pick<ControlState, 'palette' | 'paletteR' | 'paletteG' | 'paletteB'>,
) {
