...
export const PRESET_LAYER_PREFIX = "/bevyosc/preset/layer/";
export const PRESET_LAYER_ADD_ADDRESS = "/bevyosc/preset/layer/add";
export const PRESET_LAYER_WEIGHT_ADDRESS = "/bevyosc/preset/layer/weight";
export const PRESET_LAYER_REMOVE_ADDRESS = "/bevyosc/preset/layer/remove";
export const PRESET_LAYER_MOVE_ADDRESS = "/bevyosc/preset/layer/move";
export const PRESET_LAYER_CLEAR_ADDRESS = "/bevyosc/preset/layer/clear";
