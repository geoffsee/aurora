...
export const paletteSat = tgpu.fn(
  [],
  f32,
)(() => {
  'use gpu';
...
export const paletteBri = tgpu.fn(
  [],
  f32,
)(() => {
  'use gpu';
...
export const paletteRgb = tgpu.fn(
  [],
  vec3f,
)(() => {
  'use gpu';
...
export const variantEnabled = tgpu.fn(
  [f32],
  f32,
)((energy) => {
  'use gpu';
...
export const paletteTone = tgpu.fn(
  [f32, f32, f32],
  vec3f,
)((huePhase, satMul, briMul) => {
  'use gpu';
