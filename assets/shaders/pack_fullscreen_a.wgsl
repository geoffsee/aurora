// Deck A pack fullscreen slot — transparent placeholder until bridge WGSL arrives.
// Layout must match VjPackFullscreenAMaterial (including pack_drive @ binding 4).
