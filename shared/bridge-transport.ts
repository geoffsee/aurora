...
export function createWebSocketTransport(
  ...
  const scheduleReconnect = () => {
    ...
    reconnectDelay = nextReconnectDelay(reconnectDelay, options.maxReconnectDelayMs ?? 16000);
  };
...
export function createBridgedTransport(options: BridgedTransportOptions): BridgeTransport {
